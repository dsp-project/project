...
function DisplayHead($subTopic, $showButtons=true, $refresh="", $percentdone="")
{
    ...
    <html>
    <HEAD>
        <TITLE><?php echo $percentdone."DSP-Torrent-Project"; ?></TITLE>
    ...
    <tr>
        ...
        <?php DisplayTitleBar("DSP-Torrent-Project"." - ".$subTopic, $showButtons); ?>
        </td>
    </tr>
    <tr>
...
function DisplayTorrentFluxLink()
{
    ...
    echo "<a href=\"http://www.portal.aait.edu.et\" target=\"_blank\"><font class=\"tinywhite\">AAIT "."</font></a>&nbsp;&nbsp;";
    echo "</div>";
}
...
function DisplayTitleBar($pageTitleText, $showButtons=true)
{
    ...
    ?>
        ...
        <tr>
            <td align="left"><font class="title"><?php echo "DSP-Torrent-Project-2019" ?></font></td>
